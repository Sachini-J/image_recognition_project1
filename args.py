...
#    parser.add_argument(*names_or_flags: '--csv_dir', type=str, default='./data/CSVs')
    parser.add_argument('--backbone', type=str, default='fasterrcnn_resnet50_fpn', choices=['fasterrcnn_resnet50_fpn', 'fasterecnn_mobilenet_v3'])
